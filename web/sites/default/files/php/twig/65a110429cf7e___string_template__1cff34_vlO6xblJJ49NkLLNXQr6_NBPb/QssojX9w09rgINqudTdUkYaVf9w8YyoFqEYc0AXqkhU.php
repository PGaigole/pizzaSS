...
/* __string_template__1cff34108d2ea0083977b1467aa2e645 */
class __TwigTemplate_5cafbdfc91f0a7c69c7d781db8258e4b extends Template
{
    private $source;
    private $macros = [];
...
.coh-ce-cpt_text_right_background_left-40cc75a9 {
...
.coh-ce-cpt_h1_underline_top-22df8e97 {
  margin-top: 3.125rem;
...
.coh-ce-cpt_h3_underline_left-aa04e898 {
  -webkit-border-image: -webkit-gradient(linear, left top, right top, color-stop(30%, #fbae61), color-stop(30%, transparent)) 100% 1;
  -webkit-border-image: -webkit-linear-gradient(left, #fbae61 30%, transparent 30%) 100% 1;
       -o-border-image: linear-gradient(to right, #fbae61 30%, transparent 30%) 100% 1;
          border-image: -webkit-gradient(linear, left top, right top, color-stop(30%, #fbae61), color-stop(30%, transparent)) 100% 1;
          border-image: linear-gradient(to right, #fbae61 30%, transparent 30%) 100% 1;
...
.coh-ce-cpt_text_left_background_right-dca5bbca {
  padding-left: 9.375rem;
}
...
.coh-ce-cpt_h3_underline_center-b4428242 {
  margin-bottom: 1.5625rem;
  border-bottom-width: 0.1875rem;
  border-bottom-style: solid;
  border-bottom-color: rgb(251, 174, 97);
  -webkit-border-image: -webkit-gradient(linear,left top, right top,from(transparent),color-stop(10%, transparent),color-stop(10%, #fbae61),color-stop(80%, #fbae61), color-stop(80%, transparent), to(transparent)) 100% 1;
  -webkit-border-image: -webkit-linear-gradient(left,transparent 0%,transparent 10%,#fbae61 10%,#fbae61 80%, transparent 80%, transparent 100%) 100% 1;
       -o-border-image: linear-gradient(to right,transparent 0%,transparent 10%,#fbae61 10%,#fbae61 80%, transparent 80%, transparent 100%) 100% 1;
          border-image: -webkit-gradient(linear,left top, right top,from(transparent),color-stop(10%, transparent),color-stop(10%, #fbae61),color-stop(80%, #fbae61), color-stop(80%, transparent), to(transparent)) 100% 1;
          border-image: linear-gradient(to right,transparent 0%,transparent 10%,#fbae61 10%,#fbae61 80%, transparent 80%, transparent 100%) 100% 1;
}
...
";
    ...
    {
        return "__string_template__1cff34108d2ea0083977b1467aa2e645";
    }
    ...
    {
        return new Source("", "__string_template__1cff34108d2ea0083977b1467aa2e645", "");
    }
