...
/* __string_template__31db47126e03786dbb9fd1255ec42397 */
class __TwigTemplate_4a4f94ce05f3a12226d66a1c57d54c48 extends Template
{
    private $source;
    private $macros = [];
...
.coh-ce-cpt_h3_underline_center-1627fc32 {
  margin-bottom: 1.5625rem;
  border-bottom-width: 0.1875rem;
  border-bottom-style: solid;
  border-bottom-color: rgb(251, 174, 97);
  -webkit-border-image: -webkit-gradient(linear, left top, right top, color-stop(75%, transparent), color-stop(25%, #fbae61)) 100% 1;
  -webkit-border-image: -webkit-linear-gradient(left, transparent 75%, #fbae61 25%) 100% 1;
       -o-border-image: linear-gradient(to right, transparent 75%, #fbae61 25%) 100% 1;
          border-image: -webkit-gradient(linear, left top, right top, color-stop(75%, transparent), color-stop(25%, #fbae61)) 100% 1;
          border-image: linear-gradient(to right, transparent 75%, #fbae61 25%) 100% 1;
}
...
";
    ...
    {
        return "__string_template__31db47126e03786dbb9fd1255ec42397";
    }
    ...
    {
        return new Source("", "__string_template__31db47126e03786dbb9fd1255ec42397", "");
    }
