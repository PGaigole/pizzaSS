...
/* __string_template__6a6cf8c03eb845252b6434e0ccf29863 */
class __TwigTemplate_1e2d2189522c2b64b39aec48a16ac6ac extends Template
{
    private $source;
    private $macros = [];
...
.coh-ce-cpt_stretch_card_right_bg-3e8a1890 {
  background-image: -webkit-gradient(linear, left top, right top, from(rgb(255, 255, 255)), color-stop(45%, rgb(255, 255, 255)), color-stop(45%, rgb(230, 240, 231)), to(rgb(230, 240, 231)));
  background-image: -webkit-linear-gradient(left, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 45%, rgb(230, 240, 231) 45%, rgb(230, 240, 231) 100%);
  background-image: linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 45%, rgb(230, 240, 231) 45%, rgb(230, 240, 231) 100%);
  background-position: left top;
  background-size: auto;
  background-repeat: no-repeat;
  background-attachment: scroll;
...
.coh-ce-cpt_text_right_background_left-c1348a43 {
  padding-left: 9.375rem;
  background-image: -webkit-gradient(linear, left top, right top, color-stop(50%, #e6f0e7), color-stop(50%, transparent)) 100% 1;
  background-image: -webkit-linear-gradient(left, #e6f0e7 50%, transparent 50%) 100% 1;
  background-image: linear-gradient(to right, #e6f0e7 50%, transparent 50%) 100% 1;
}
...
";
    ...
    {
        return "__string_template__6a6cf8c03eb845252b6434e0ccf29863";
    }
    ...
    {
        return new Source("", "__string_template__6a6cf8c03eb845252b6434e0ccf29863", "");
    }
