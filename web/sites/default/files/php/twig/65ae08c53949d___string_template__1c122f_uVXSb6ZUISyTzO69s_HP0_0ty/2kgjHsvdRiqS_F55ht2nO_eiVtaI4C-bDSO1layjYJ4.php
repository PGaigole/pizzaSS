...
/* __string_template__1c122f8fc54dbd8cf4e2f00d7f30d82f */
class __TwigTemplate_ed5ad4211350034d9600068536a8cdb2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block871475089' => [$this, 'block_block871475089'],
            'block2095518968' => [$this, 'block_block2095518968'],
            'block542465306' => [$this, 'block_block542465306'],
            'block2155442117' => [$this, 'block_block2155442117'],
            'block313743958' => [$this, 'block_block313743958'],
            'block48595677' => [$this, 'block_block48595677'],
            'block1446317272' => [$this, 'block_block1446317272'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block871475089', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2095518968', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block542465306', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2155442117', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block313743958', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block48595677', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1446317272', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block871475089($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2095518968($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block542465306($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2155442117($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block313743958($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block48595677($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1446317272($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__1c122f8fc54dbd8cf4e2f00d7f30d82f";
    }
    ...
    {
        return new Source("", "__string_template__1c122f8fc54dbd8cf4e2f00d7f30d82f", "");
    }
