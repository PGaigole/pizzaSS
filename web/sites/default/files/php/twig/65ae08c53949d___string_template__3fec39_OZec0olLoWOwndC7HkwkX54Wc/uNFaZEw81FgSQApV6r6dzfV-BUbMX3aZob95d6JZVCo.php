...
/* __string_template__3fec3981b3168c595f5e8bdca7567b51 */
class __TwigTemplate_8e058045226cba73ce739c9a023868ed extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block775880828' => [$this, 'block_block775880828'],
            'block3946308710' => [$this, 'block_block3946308710'],
            'block3582691449' => [$this, 'block_block3582691449'],
            'block1501518188' => [$this, 'block_block1501518188'],
            'block3109764089' => [$this, 'block_block3109764089'],
            'block4257606213' => [$this, 'block_block4257606213'],
            'block1727649614' => [$this, 'block_block1727649614'],
            'block1026132237' => [$this, 'block_block1026132237'],
            'block1475345721' => [$this, 'block_block1475345721'],
            'block4294964069' => [$this, 'block_block4294964069'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block775880828', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3946308710', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3582691449', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1501518188', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3109764089', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4257606213', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1727649614', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1026132237', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1475345721', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4294964069', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block775880828($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3946308710($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3582691449($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1501518188($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3109764089($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4257606213($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1727649614($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1026132237($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1475345721($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4294964069($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__3fec3981b3168c595f5e8bdca7567b51";
    }
    ...
    {
        return new Source("", "__string_template__3fec3981b3168c595f5e8bdca7567b51", "");
    }
