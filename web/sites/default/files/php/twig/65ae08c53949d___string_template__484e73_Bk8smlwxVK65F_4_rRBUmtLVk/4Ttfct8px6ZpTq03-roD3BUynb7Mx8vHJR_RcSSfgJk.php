...
/* __string_template__484e73e77dbf47fbf1ddfa7377f1dd08 */
class __TwigTemplate_215ebfaa85e5c9c9391c22ce09a163c8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block780792921' => [$this, 'block_block780792921'],
            'block44292012' => [$this, 'block_block44292012'],
            'block3178290703' => [$this, 'block_block3178290703'],
            'block754456684' => [$this, 'block_block754456684'],
            'block3285920762' => [$this, 'block_block3285920762'],
            'block2369636380' => [$this, 'block_block2369636380'],
            'block154399613' => [$this, 'block_block154399613'],
            'block252258442' => [$this, 'block_block252258442'],
            'block3770165977' => [$this, 'block_block3770165977'],
            'block3757674176' => [$this, 'block_block3757674176'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block780792921', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block44292012', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3178290703', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block754456684', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3285920762', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2369636380', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block154399613', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block252258442', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3770165977', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3757674176', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block780792921($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block44292012($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3178290703($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block754456684($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3285920762($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2369636380($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block154399613($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block252258442($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3770165977($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3757674176($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__484e73e77dbf47fbf1ddfa7377f1dd08";
    }
    ...
    {
        return new Source("", "__string_template__484e73e77dbf47fbf1ddfa7377f1dd08", "");
    }
