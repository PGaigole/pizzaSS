...
/* __string_template__5ddfaa4835640d442b8de99e0b31a505 */
class __TwigTemplate_a149c6434e05734921b782ed079cf500 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block296429093' => [$this, 'block_block296429093'],
            'block919072077' => [$this, 'block_block919072077'],
            'block3206710939' => [$this, 'block_block3206710939'],
            'block3524036427' => [$this, 'block_block3524036427'],
            'block1910858274' => [$this, 'block_block1910858274'],
            'block1240373544' => [$this, 'block_block1240373544'],
            'block2357457123' => [$this, 'block_block2357457123'],
            'block3153116709' => [$this, 'block_block3153116709'],
            'block2950508702' => [$this, 'block_block2950508702'],
            'block4066631032' => [$this, 'block_block4066631032'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block296429093', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block919072077', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3206710939', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3524036427', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1910858274', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1240373544', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2357457123', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3153116709', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2950508702', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4066631032', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block296429093($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block919072077($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3206710939($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3524036427($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1910858274($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1240373544($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2357457123($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3153116709($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2950508702($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4066631032($context, array $blocks = [])
    {
        $macros = $this->macros;
        ...
        echo " ";
        $context["component_variable_786a8a8d_ae32_4594_9482_ad4f3d2b84b2"] = ('' === $tmp = "25px") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_ed362bf5_72ca_4586_a2c9_91a41482d940"] = ('' === $tmp = "rgba(251, 174, 97, 1)") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
    ...
    {
        return "__string_template__5ddfaa4835640d442b8de99e0b31a505";
    }
    ...
    {
        return new Source("", "__string_template__5ddfaa4835640d442b8de99e0b31a505", "");
    }
