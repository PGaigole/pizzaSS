...
/* __string_template__5e25f856791e235caa6ad079138ad344 */
class __TwigTemplate_cdb8c59649d36cfce8de0452c5cb3bc2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block2528260789' => [$this, 'block_block2528260789'],
            'block1941099794' => [$this, 'block_block1941099794'],
            'block1897766506' => [$this, 'block_block1897766506'],
            'block2594962160' => [$this, 'block_block2594962160'],
            'block389679492' => [$this, 'block_block389679492'],
            'block3768856418' => [$this, 'block_block3768856418'],
            'block517518543' => [$this, 'block_block517518543'],
            'block4094333514' => [$this, 'block_block4094333514'],
            'block4118486779' => [$this, 'block_block4118486779'],
            'block1870981828' => [$this, 'block_block1870981828'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2528260789', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1941099794', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1897766506', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2594962160', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block389679492', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3768856418', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block517518543', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4094333514', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4118486779', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1870981828', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block2528260789($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1941099794($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1897766506($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2594962160($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block389679492($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3768856418($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block517518543($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4094333514($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4118486779($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1870981828($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__5e25f856791e235caa6ad079138ad344";
    }
    ...
    {
        return new Source("", "__string_template__5e25f856791e235caa6ad079138ad344", "");
    }
