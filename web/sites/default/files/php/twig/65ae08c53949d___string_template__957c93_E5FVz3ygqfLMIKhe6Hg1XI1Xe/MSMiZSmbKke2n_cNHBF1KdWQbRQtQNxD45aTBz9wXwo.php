...
/* __string_template__957c93e82eee546cd85fbe8a9daa76d5 */
class __TwigTemplate_3d3d2b0fed71a5adfba90672bd1730de extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block3712681142' => [$this, 'block_block3712681142'],
            'block3505046839' => [$this, 'block_block3505046839'],
            'block752102841' => [$this, 'block_block752102841'],
            'block2589108792' => [$this, 'block_block2589108792'],
            'block1073576668' => [$this, 'block_block1073576668'],
            'block1046198278' => [$this, 'block_block1046198278'],
            'block3620396334' => [$this, 'block_block3620396334'],
            'block7679823' => [$this, 'block_block7679823'],
            'block1036862725' => [$this, 'block_block1036862725'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3712681142', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3505046839', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block752102841', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2589108792', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1073576668', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1046198278', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3620396334', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block7679823', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1036862725', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block3712681142($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3505046839($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block752102841($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2589108792($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1073576668($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1046198278($context, array $blocks = [])
    {
        $macros = $this->macros;
        ...
        echo " ";
        $context["component_variable_5ffb52fb_88aa_4e51_ab86_1f29487aee4d"] = ('' === $tmp = "4th place.") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_1b6b9977_5387_40ed_8cef_c6deded27902"] = ('' === $tmp = "Pizza \"Four cheese\"") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_9c631b39_2db5_4296_ab24_b33178f93039"] = ('' === $tmp = "A real find for lovers of noble varieties of cheese. This type of pizza does not use tomato paste, which interrupts the delicate taste and aroma of melting Mozzarella, Parmesan, Dor Blue and Fontina cheeses.") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        ob_start(function () { return ''; });
        ...
        $context["component_variable_e58560a3_60d7_4380_ad18_0401911779d1"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_3e369250_8cf6_4170_92e1_34e078723b06"] = ('' === $tmp = "rgba(255, 209, 157, 1)") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_7c23ba68_d649_40bc_88f4_9dd2573b1227"] = ('' === $tmp = "25px") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->renderComponent("cpt_spread_card_left_bg", false, $this->sandbox->ensureToStringAllowed($context, 1, $this->source), ["5ffb52fb-88aa-4e51-ab86-1f29487aee4d" => "component_variable_5ffb52fb_88aa_4e51_ab86_1f29487aee4d", "1b6b9977-5387-40ed-8cef-c6deded27902" => "component_variable_1b6b9977_5387_40ed_8cef_c6deded27902", "9c631b39-2db5-4296-ab24-b33178f93039" => "component_variable_9c631b39_2db5_4296_ab24_b33178f93039", "e58560a3-60d7-4380-ad18-0401911779d1" => "component_variable_e58560a3_60d7_4380_ad18_0401911779d1", "3e369250-8cf6-4170-92e1-34e078723b06" => "component_variable_3e369250_8cf6_4170_92e1_34e078723b06", "7c23ba68-d649-40bc-88f4-9dd2573b1227" => "component_variable_7c23ba68_d649_40bc_88f4_9dd2573b1227"], "6f22a071-6902-4daf-ab6b-1acb791bcee8", ""), "html", null, true);
        echo " ";
    ...
    public function block_block3620396334($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block7679823($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1036862725($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__957c93e82eee546cd85fbe8a9daa76d5";
    }
    ...
    {
        return new Source("", "__string_template__957c93e82eee546cd85fbe8a9daa76d5", "");
    }
