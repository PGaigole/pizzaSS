...
/* __string_template__dfdb61b82e586d2b17d6ad04739d0c14 */
class __TwigTemplate_513c57866c684f4c4ca748bc8c0d79bb extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block71089787' => [$this, 'block_block71089787'],
            'block39249870' => [$this, 'block_block39249870'],
            'block2687133479' => [$this, 'block_block2687133479'],
            'block415300640' => [$this, 'block_block415300640'],
            'block1944494267' => [$this, 'block_block1944494267'],
            'block1709529813' => [$this, 'block_block1709529813'],
            'block2441703540' => [$this, 'block_block2441703540'],
            'block1793998745' => [$this, 'block_block1793998745'],
            'block627525405' => [$this, 'block_block627525405'],
            'block875087935' => [$this, 'block_block875087935'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block71089787', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block39249870', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2687133479', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block415300640', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1944494267', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1709529813', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2441703540', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1793998745', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block627525405', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block875087935', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block71089787($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block39249870($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2687133479($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block415300640($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1944494267($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1709529813($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2441703540($context, array $blocks = [])
    {
        $macros = $this->macros;
        ...
        $context["component_variable_082b67c1_6a47_43d4_9407_009934b7ceff"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_9d4a657d_e7f9_46a3_a7ab_b433ac796732"] = ('' === $tmp = "rgba(255, 209, 157, 1)") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        $context["component_variable_8e13954e_42d3_482f_bf3a_d7d6b9d455b6"] = ('' === $tmp = "25px") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
    ...
    public function block_block1793998745($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block627525405($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block875087935($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__dfdb61b82e586d2b17d6ad04739d0c14";
    }
    ...
    {
        return new Source("", "__string_template__dfdb61b82e586d2b17d6ad04739d0c14", "");
    }
