...
/* __string_template__e0850963bb029643a8c135ff354ae652 */
class __TwigTemplate_75516b30dcefae7ddbc63bba69fdd7d9 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block2295969038' => [$this, 'block_block2295969038'],
            'block280632860' => [$this, 'block_block280632860'],
            'block842018322' => [$this, 'block_block842018322'],
            'block1604065391' => [$this, 'block_block1604065391'],
            'block3926073389' => [$this, 'block_block3926073389'],
            'block1115291932' => [$this, 'block_block1115291932'],
            'block3282241738' => [$this, 'block_block3282241738'],
            'block3154010841' => [$this, 'block_block3154010841'],
            'block4097457725' => [$this, 'block_block4097457725'],
            'block593284700' => [$this, 'block_block593284700'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2295969038', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block280632860', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block842018322', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1604065391', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3926073389', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1115291932', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3282241738', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3154010841', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4097457725', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block593284700', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block2295969038($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block280632860($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block842018322($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1604065391($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3926073389($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1115291932($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3282241738($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3154010841($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4097457725($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block593284700($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__e0850963bb029643a8c135ff354ae652";
    }
    ...
    {
        return new Source("", "__string_template__e0850963bb029643a8c135ff354ae652", "");
    }
