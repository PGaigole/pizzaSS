...
/* __string_template__e15744b56ef0bac54affb4359b2b61db */
class __TwigTemplate_ec961cc6676d5f6bfc2a3da75520b3f5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block3257936429' => [$this, 'block_block3257936429'],
            'block1436903781' => [$this, 'block_block1436903781'],
            'block3508652540' => [$this, 'block_block3508652540'],
            'block1215898688' => [$this, 'block_block1215898688'],
            'block2420178195' => [$this, 'block_block2420178195'],
            'block2875579753' => [$this, 'block_block2875579753'],
            'block3146652581' => [$this, 'block_block3146652581'],
            'block3316590145' => [$this, 'block_block3316590145'],
            'block234631118' => [$this, 'block_block234631118'],
            'block1279829693' => [$this, 'block_block1279829693'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3257936429', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1436903781', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3508652540', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1215898688', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2420178195', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2875579753', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3146652581', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3316590145', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block234631118', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1279829693', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block3257936429($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1436903781($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3508652540($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1215898688($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2420178195($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2875579753($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3146652581($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3316590145($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block234631118($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1279829693($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__e15744b56ef0bac54affb4359b2b61db";
    }
    ...
    {
        return new Source("", "__string_template__e15744b56ef0bac54affb4359b2b61db", "");
    }
