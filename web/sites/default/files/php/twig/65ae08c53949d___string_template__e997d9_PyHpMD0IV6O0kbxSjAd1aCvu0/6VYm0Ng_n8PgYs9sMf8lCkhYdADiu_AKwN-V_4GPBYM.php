...
/* __string_template__e997d961872797505e41882c6513845a */
class __TwigTemplate_c3b6b5ffef4ffcfa80b5f9eef67ea71e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block2674020047' => [$this, 'block_block2674020047'],
            'block1240187512' => [$this, 'block_block1240187512'],
            'block3809985319' => [$this, 'block_block3809985319'],
            'block2290948941' => [$this, 'block_block2290948941'],
            'block2459922991' => [$this, 'block_block2459922991'],
            'block94671557' => [$this, 'block_block94671557'],
            'block4243680421' => [$this, 'block_block4243680421'],
            'block3545477713' => [$this, 'block_block3545477713'],
            'block2153994361' => [$this, 'block_block2153994361'],
            'block538285363' => [$this, 'block_block538285363'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2674020047', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1240187512', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3809985319', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2290948941', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2459922991', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block94671557', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4243680421', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3545477713', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2153994361', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block538285363', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block2674020047($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1240187512($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3809985319($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2290948941($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2459922991($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block94671557($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4243680421($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3545477713($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2153994361($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block538285363($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__e997d961872797505e41882c6513845a";
    }
    ...
    {
        return new Source("", "__string_template__e997d961872797505e41882c6513845a", "");
    }
