...
/* __string_template__ef7d836eb2efc67fb9115e6823def05a */
class __TwigTemplate_ffeac387d90b5389c4dce7f6dd6a4b76 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block3563546484' => [$this, 'block_block3563546484'],
            'block3444074675' => [$this, 'block_block3444074675'],
            'block1752194143' => [$this, 'block_block1752194143'],
            'block3550841794' => [$this, 'block_block3550841794'],
            'block2141211596' => [$this, 'block_block2141211596'],
            'block3860204615' => [$this, 'block_block3860204615'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3563546484', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3444074675', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1752194143', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3550841794', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2141211596', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3860204615', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block3563546484($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3444074675($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1752194143($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3550841794($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2141211596($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3860204615($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__ef7d836eb2efc67fb9115e6823def05a";
    }
    ...
    {
        return new Source("", "__string_template__ef7d836eb2efc67fb9115e6823def05a", "");
    }
