...
";
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("attach_library" => 1, "getComponentFieldValue" => 1, "get_content_language" => 1);

        try {
            $this->sandbox->checkSecurity(
                ['if', 'trans'],
                ['escape', 'number_format'],
                ['attach_library', 'getComponentFieldValue', 'get_content_language']
            );
