...
/* __string_template__a299a5a8e57c7654dc06f48158488b72 */
class __TwigTemplate_f0caf0e0a915263eb2885f5bbc02dbe5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block2146426861' => [$this, 'block_block2146426861'],
            'block1684526071' => [$this, 'block_block1684526071'],
            'block1820584117' => [$this, 'block_block1820584117'],
            'block3875316826' => [$this, 'block_block3875316826'],
            'block2310102912' => [$this, 'block_block2310102912'],
            'block2814503695' => [$this, 'block_block2814503695'],
            'block823720752' => [$this, 'block_block823720752'],
            'block2662526140' => [$this, 'block_block2662526140'],
            'block4011021401' => [$this, 'block_block4011021401'],
            'block2074399303' => [$this, 'block_block2074399303'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2146426861', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1684526071', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1820584117', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3875316826', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2310102912', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2814503695', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block823720752', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2662526140', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4011021401', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2074399303', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block2146426861($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1684526071($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1820584117($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3875316826($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2310102912($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2814503695($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block823720752($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2662526140($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4011021401($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2074399303($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__a299a5a8e57c7654dc06f48158488b72";
    }
    ...
    {
        return new Source("", "__string_template__a299a5a8e57c7654dc06f48158488b72", "");
    }
