...
/* __string_template__fff9a65a4a6bac9c801ef98ddd446661 */
class __TwigTemplate_9f446e114ba2638ba11188bdd7a55295 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block2475841709' => [$this, 'block_block2475841709'],
            'block1745548825' => [$this, 'block_block1745548825'],
            'block2530682836' => [$this, 'block_block2530682836'],
            'block468989148' => [$this, 'block_block468989148'],
            'block282612057' => [$this, 'block_block282612057'],
            'block1473326047' => [$this, 'block_block1473326047'],
            'block2017975813' => [$this, 'block_block2017975813'],
            'block2440905147' => [$this, 'block_block2440905147'],
            'block1566769428' => [$this, 'block_block1566769428'],
            'block2643378018' => [$this, 'block_block2643378018'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2475841709', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1745548825', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2530682836', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block468989148', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block282612057', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1473326047', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2017975813', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2440905147', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1566769428', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block2643378018', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block2475841709($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1745548825($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2530682836($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block468989148($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block282612057($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1473326047($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2017975813($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2440905147($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block1566769428($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block2643378018($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__fff9a65a4a6bac9c801ef98ddd446661";
    }
    ...
    {
        return new Source("", "__string_template__fff9a65a4a6bac9c801ef98ddd446661", "");
    }
