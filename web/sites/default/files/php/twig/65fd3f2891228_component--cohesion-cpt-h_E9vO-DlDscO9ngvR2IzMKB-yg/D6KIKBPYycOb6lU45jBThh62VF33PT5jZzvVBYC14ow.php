...
class __TwigTemplate_40ede3b439c4638b60ad55df7557e341 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  background-attachment: scroll;
    ...
    {
        return array (  109 => 9,  101 => 4,  88 => 3,  82 => 2,  39 => 1,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("coh_instanceid" => 1, "attach_library" => 1, "contextpasses" => 1, "render_field_uuid" => 1, "getComponentFieldValue" => 1, "cohesion_image_style" => 3, "renderInlineStyle" => 9);

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['escape', 'raw'],
                ['coh_instanceid', 'attach_library', 'contextpasses', 'render_field_uuid', 'getComponentFieldValue', 'cohesion_image_style', 'renderInlineStyle']
            );
