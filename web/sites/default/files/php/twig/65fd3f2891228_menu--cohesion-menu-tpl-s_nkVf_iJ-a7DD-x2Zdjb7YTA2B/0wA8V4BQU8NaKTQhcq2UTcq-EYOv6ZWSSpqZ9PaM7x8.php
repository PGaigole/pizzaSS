...
/* sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-social-icons-menu-templ.html.twig */
class __TwigTemplate_ce27b454ddacf84ac46745d192566680 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block1646188294' => [$this, 'block_block1646188294'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->displayBlock('block1646188294', $context, $blocks);
        echo " </div> 
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["item", "items"]);    }

    public function block_block1646188294($context, array $blocks = [])
    {
        $macros = $this->macros;
        echo " ";
        if (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) || (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", false, false, true, 1)) > 0)))) {
            echo " <ul class=\"coh-menu-list-container coh-unordered-list coh-ce-dd2d2b42\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((($context["i"] <= twig_length_filter($this->env, ($context["items"] ?? null))) && ($context["inRange"] ?? null))) {
                    ...
                    echo "<li class=\"coh-menu-list-item coh-style-social-icons coh-ce-a586471a js-coh-menu-item";
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1)) {
                        ...
                        echo " data-coh-settings='{ \"xl\":{\"link_interaction\":\"click-through-to-link\"} }' class=\"coh-link coh-ce-50a4b5f js-coh-menu-item-link";
    ...
    {
        return "sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-social-icons-menu-templ.html.twig";
    }
    ...
    {
        return new Source("", "sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-social-icons-menu-templ.html.twig", "/var/www/html/web/sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-social-icons-menu-templ.html.twig");
    }
